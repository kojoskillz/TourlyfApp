...
export default function ProfileScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      // Save both preferences and user name
      await AsyncStorage.setItem('userTravelPreferences', JSON.stringify(preferences));
      await AsyncStorage.setItem('userName', userName);
      
      Alert.alert('Success', 'Preferences saved!');
      // Navigate to travel page 
      router.replace('../../TravelInterface/travelInterface');
    } catch (error) {
